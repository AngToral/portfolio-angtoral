...
function Mariana() {
    ...
    const [t, i18n] = useTranslation("mariana")
        ...
        <>
            ...
            <div className="flex flex-col m-8 w-full justify-center gap-5 items-center">
                <img
                    ...
                    src="../logo-mariana.avif"
                    alt="mariana"
                />
                <a target='_blanck' href="https://nanamendozago.com" >
            ...
            <div className="flex justify-center">
                <div className="flex md:flex-row flex-col w-2/3 m-8 mt-0 gap-5 items-start">
                    <IconContext.Provider
                        value={{ color: '#fff' }}
                    >
                        <div className="md:w-1/3 flex flex-col items-center gap-2 h-[260px] bg-projects-100 p-5 rounded-lg" >
                        ...
                        <div className="md:w-1/3 flex flex-col items-center h-[260px] bg-projects-100 p-5 rounded-lg" >
            ...
            <div className="budget flex flex-col m-8 mt-4 w-full gap-5 items-center">
                <div className="md:w-1/2 flex flex-col gap-5">
                    <div className="flex justify-around">
                        <p className="font-spinnaker text-projects-100 text-xl">{t("wise.features")}</p>
                    </div>
