                    ...
                    <Timeline>
                        <TimelineItem>
                            ...
                            <TimelineHeader className="h-3">
                                ...
                                <Typography className="lg:text-lg font-spinnaker text-projects-100 leading-none">
                                    {t("wise.time")}
                                </Typography>
                            </TimelineHeader>
                        ...
                        <TimelineItem>
                            ...
                            <TimelineHeader className="h-3">
                                <TimelineIcon className="bg-white" />
                                <Typography className="lg:text-lg font-spinnaker text-projects-100 eading-none">
                                    {t("wise.team")}
                                </Typography>
                            </TimelineHeader>
                            <TimelineBody className="pb-8">
            ...
            <div className="flex budget justify-center animate__animated animate__fadeInDown gap-8 md:p-10 p-6 pt-4">
                <div className="md:w-1/2 flex flex-col">
                    <div className="flex justify-around my-6">
                        <Button className="link font-spinnaker text-projects-100" size="lg" onClick={toggleOpenFuncionality}>{t("wise.features")}</Button>
                    </div>
